...
public class CSVParsing 
{
    ...
    void Start()
    {
        filePath = IGamaManager.RESOURCES_PATH + fileName;
        readData();
    }
    ...
    public void addData()
    {
        ...
        File.AppendAllText(getPath() + "/"+ filePath, lineSeperater + rollNoInputField.text + fieldSeperator + nameInputField.text);
