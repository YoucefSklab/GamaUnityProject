...
public class TestObject : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        g1.transform.position = new Vector3(p.x, p.y - 20, p.z);
       ...
       g2.transform.position = new Vector3(p.x, p.y - 20, p.z);
        ...
        g3.transform.position = new Vector3(p.x, p.y - 20, p.z);
        ...
        g4.transform.position = new Vector3(p.x, p.y - 20, p.z);
